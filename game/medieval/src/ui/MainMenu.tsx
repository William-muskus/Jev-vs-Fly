...
export function MainMenu({ onStart, onJevVsFly, onOpenSettings, muster, onMuster, attract, onInteract }: MainMenuProps) {
  ...
  return (
    ...
    >
      <div className="mc-unfurl mc-menu-hero mb-6 shrink-0 text-center">
        ...
        <p className="mc-display mt-2 text-[0.68rem] tracking-[0.4em] text-[#c8ab74]">JEV vs FLY</p>
        <p className="mt-3 text-sm italic text-[#c5b28d]">
          {attract
            ? "An enchanted duel is under way — move to take the hall"
        ...
        {onJevVsFly ? (
          <button
            ...
            onClick={onJevVsFly}
          >
            <Swords size={16} /> Play wizard chess
          </button>
        ) : null}
      </div>
